...
//     const totalWeight = existingGoals.reduce(
...
//         return res.status(403).json({
//           error: "Managers can only delete team goals"
//         });
//       }
//     }
...
//     // 🔥 CHECK: goal belongs to manager's team
...
//     res.json({ message: "Goal approved", updated });
...
//       return res.status(403).json({
//         error: "You can only reject your team goals"
//       });
//     }
...
//   return res.status(400).json({
//     error: "Approved/completed goals cannot be modified"
//   });
// }
